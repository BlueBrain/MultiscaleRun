...
#     PCr_n0 = 4.9460223423181864e+000;    PCr_a0 = 4.9242059083825644e+000
    ...
    INa         =  ina_density #gNa*minf^3*h*(V-RTF*log(Na_out/Na_n)); #####################
    IK          =  ik_density #gK*n^4*(V-EK); ############################
    ...
    du[96] = SmVn/F*ik_density*(eto_n/eto_ecs) - 2*vPumpn*(eto_n/eto_ecs) - 2*(eto_a/eto_ecs)*vPumpg - JdiffK  -( ( - IleakA - IBK - IKirAS - IKirAV)/(4e-4*843.0*1000.))     #  K_out
    ...
    du[98] = 1/Cm*(-IL-ina_density-ik_density-ICa-ImAHP-dIPump)  # VNeu
    
    du[99] = 0 # vLeakNan-3*vPumpn + vnstim # Na_n
